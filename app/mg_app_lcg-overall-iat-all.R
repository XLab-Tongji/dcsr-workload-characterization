...
## DESCRIPTION
##  Writes:
##  * a data-file containing the overall interarrival times for LCG log;
...
options( error = quote( dump.frames( "mg_app_lcg-overall-iat-all", TRUE ) ) ); #DEBUG
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Reading IAT file" );

iat <- mg_lcg_overallInterArrTimes( lcg );

# BEGIN Writes samples to data file
write(
	iat,
	paste( MG_APP_CONF_LCG_VIEWPATH, "/lcg-overall-iat.data", sep = "" ),
	ncolumns = 1
);
# END Writes samples to data file

sink( file = paste( MG_APP_CONF_LCG_STATSPATH, "/lcg-overall-iat-stats.out", sep = "" ) );

##@{ EDA shape plot
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting EDA Shape Plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-eda-shape.eps", sep = "" ), horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-eda-shape.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Writing summary statistics" );
...
# BEGIN Plot trend
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting trend" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-trend.eps", sep = "" ),
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-trend.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting frequency histogram" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fhist.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fhist.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting density histogram" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-dhist.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-dhist.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting Lag-1 plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lag1.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lag1.eps", sep = "" ) );
	warning( "Error while drawing Lag-1 plot." );
	warning( "Error message is: ", geterrmessage() );
}
# END Plot lag-1 plot

##@{ Plot and print Heavy-Tailed indicators
##@} Plot and print Heavy-Tailed indicators

##@{ Distribution fitting (parameters estimated from data set)

mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Fitting distributions" );
...
#postscript(
#	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llcd.eps", sep = "" ),
#	#title = "LCG - Overall Interarrival Times",
#	horizontal = FALSE,
#	onefile = FALSE
#);
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Distribution multi fitting" );
fit <- try(
	mg_fit_multifit(
		iat,
		fitDistrs
...
if ( is( fit, "try-error" ) )
{
	#unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llcd.eps", sep = "" ) );
...
# Draw a CCDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing a CCDF plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-ccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-ccdf.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing a LLCCDF plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llccdf.eps", sep = "" ) );
...
# Draw a CDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing a CDF plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-cdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-cdf.eps", sep = "" ) );
...
# Draw a LLCDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing a LLCDF plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llcdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-llcdf.eps", sep = "" ) );
...
# Draw a PDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing a PDF plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-pdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-fit-pdf.eps", sep = "" ) );
...
#	);
#END don't work
	mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Doing Goodness-of-Fit tests for '", fitDistr, "' distribution" );
	res <- try(
		do.call(
			"mg_gof_multigof.test",
			c(
...
#						MG_CONSTS_QQ_GOF
	...
	# BEGIN Q-Q Plot
	mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing Q-Q Plot for '", fitDistr, "' distribution" );
	cat( "## Q-Q Plot:", "\n" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-qqplot.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( !is( res, "try-error" ) )
	{
		...
		cat( "\t", "Correlation Coeff.: ", paste( "Pearson: ", res$cor.pearson$estimate, " @ [", res$cor.pearson$conf.int[1], ",", res$cor.pearson$conf.int[2], "] (p-value: ", res$cor.pearson$p.value, ")" ), "\n" );
		cat( "\t", "Area Difference: Absolute: ", res$abs.area.diff, ", Relative: ", res$rel.area.diff, "\n" );
	} else {
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-qqplot.eps", sep = "" ) );
...
#	mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing Log-Log Q-Q Plot for '", fitDistr, "' distribution" );
#	cat( "## Log-Log Q-Q Plot:", "\n" );
#	postscript(
#		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-llqqplot.eps", sep = "" ),
#		horizontal = FALSE,
#		onefile = FALSE
#	);
#	res <- try(
...
#		cat( "\t", "Area Difference: Absolute: ", res$abs.area.diff, ", Relative: ", res$rel.area.diff, "\n" );
#	} else {
#		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-llqqplot.eps", sep = "" ) );
...
#	# END Log-Log Q-Q Plot
	...
	# BEGIN P-P Plot
	mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing P-P Plot for '", fitDistr, "' distribution" );
	cat( "## P-P Plot:", "\n" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-ppplot.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( !is( res, "try-error" ) )
	{
		...
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-", fitDistr, "fit-ppplot.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing ACF Plot" );
cat( "## ACF statistics and plot:", "\n" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-acf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-acf.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Plotting EDA Autocorrelation Plot" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-eda-acor.eps", sep = "" ), horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-eda-acor.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing Long Range Dependence indicators Plot" );
cat( "## Long Range Dependence indicators statistics and plots:", "\n" );

##@{ Aggregated trend plot
cat( "## LRD Aggregated Trends plot:", "\n" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-aggtrend.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-aggtrend.eps", sep = "" ) );
...
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-aggllecdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-aggllecdf.eps", sep = "" ) );
...
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-agglleccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-agglleccdf.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-av.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-av.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-rs.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-rs.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-pgram.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-pgram.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-cumpgram.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-lrd-cumpgram.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::LCG::IAT>> Drawing Hill Plot" );
cat( "## Hill estimator:", "\n" );
postscript(
	file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-hill.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-overall-iat-hill.eps", sep = "" ) );

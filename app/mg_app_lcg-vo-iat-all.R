...
options( error = quote( dump.frames( "mg_app_lcg-vo-iat-all", TRUE ) ) ); #DEBUG
...
for ( vo in voNames )
{
	...
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Writing samples" );
	write(
		iat,
		paste( MG_APP_CONF_LCG_VIEWPATH, "/lcg-vo_", vo, "-iat.data", sep = "" ),
		ncolumns = 1
	);
	# END Writes samples to data file

	sink( paste( MG_APP_CONF_LCG_STATSPATH, "/lcg-vo_", vo, "-iat-stats.out", sep = "" ) );
...
#	dev.off();
	...
	# Draw a CCDF plot
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Drawing a CCDF plot" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-ccdf.eps", sep = "" ),
		#title = paste( "LCG - VO '", vo, "' Interarrival Times", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-ccdf.eps", sep = "" ) );
	...
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Drawing a LLCCDF plot" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-llccdf.eps", sep = "" ),
		#title = paste( "LCG - VO '", vo, "' Interarrival Times", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-llccdf.eps", sep = "" ) );
	...
	# Draw a CDF plot
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Drawing a CDF plot" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-cdf.eps", sep = "" ),
		#title = paste( "LCG - VO '", vo, "' Interarrival Times", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-cdf.eps", sep = "" ) );
	...
	# Draw a LLCDF plot
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Drawing a LLCDF plot" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-llcdf.eps", sep = "" ),
		#title = paste( "LCG - VO '", vo, "' Interarrival Times", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-llcdf.eps", sep = "" ) );
	...
	# Draw a PDF plot
	mg_debug.message( dbg, "[MG::APP::VO::LCG::IAT>> Drawing a PDF plot" );
	postscript(
		file = paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-pdf.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_LCG_IMGPATH, "/lcg-vo_", vo, "-iat-fit-pdf.eps", sep = "" ) );

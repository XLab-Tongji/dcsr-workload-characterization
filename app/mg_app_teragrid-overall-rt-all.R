...
## MG_APP_TERAGRID-OVERALL-RT-ALL
##
## SUMMARY
##  TeraGrid - Overall runtimes.
##
## DESCRIPTION
##  Writes:
...
options( error = quote( dump.frames( "mg_app_teragrid-overall-rt-all", TRUE ) ) ); #DEBUG
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Reading RT file" );

rt <- mg_teragrid_overallRuntimes( teragrid );

# BEGIN Writes samples to data file
write(
	rt,
	paste( MG_APP_CONF_TERAGRID_VIEWPATH, "/teragrid-overall-rt.data", sep = "" ),
	ncolumns = 1
);
# END Writes samples to data file

sink( file = paste( MG_APP_CONF_TERAGRID_STATSPATH, "/teragrid-overall-rt-stats.out", sep = "" ) );

##@{ EDA shape plot
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting EDA Shape Plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-eda-shape.eps", sep = "" ), horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-eda-shape.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Writing summary statistics" );
...
# BEGIN Plot trend
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting trend" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-trend.eps", sep = "" ),
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-trend.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting frequency histogram" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fhist.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fhist.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting density histogram" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-dhist.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-dhist.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting Lag-1 plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lag1.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lag1.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Fitting distributions" );
...
#postscript(
#	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llcd.eps", sep = "" ),
#	#title = "TERAGRID - Overall Interarrival Times",
#	horizontal = FALSE,
#	onefile = FALSE
#);
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Distribution multi fitting" );
fit <- try(
	mg_fit_multifit(
		rt,
		fitDistrs
...
if ( is( fit, "try-error" ) )
{
	#unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llcd.eps", sep = "" ) );
...
# Draw a CCDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing a CCDF plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-ccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-ccdf.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing a LLCCDF plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llccdf.eps", sep = "" ) );
...
# Draw a CDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing a CDF plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-cdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-cdf.eps", sep = "" ) );
...
# Draw a LLCDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing a LLCDF plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llcdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-llcdf.eps", sep = "" ) );
...
# Draw a PDF plot
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing a PDF plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-pdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-fit-pdf.eps", sep = "" ) );
...
#	);
#END don't work
	mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Doing Goodness-of-Fit tests for '", fitDistr, "' distribution" );
	res <- try(
		do.call(
			"mg_gof_multigof.test",
			c(
...
#						MG_CONSTS_QQ_GOF
	...
	# BEGIN Q-Q Plot
	mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing Q-Q Plot for '", fitDistr, "' distribution" );
	cat( "## Q-Q Plot:", "\n" );
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-qqplot.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( !is( res, "try-error" ) )
	{
		...
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-qqplot.eps", sep = "" ) );
...
#	mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing Log-Log Q-Q Plot for '", fitDistr, "' distribution" );
#	cat( "## Log-Log Q-Q Plot:", "\n" );
#	postscript(
#		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-llqqplot.eps", sep = "" ),
#		horizontal = FALSE,
#		onefile = FALSE
#	);
#	res <- try(
...
#		cat( "\t", "Area Difference: Absolute: ", res$abs.area.diff, ", Relative: ", res$rel.area.diff, "\n" );
#	} else {
#		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-llqqplot.eps", sep = "" ) );
...
#	# END Log-Log Q-Q Plot
	...
	# BEGIN P-P Plot
	mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing P-P Plot for '", fitDistr, "' distribution" );
	cat( "## P-P Plot:", "\n" );
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-ppplot.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( !is( res, "try-error" ) )
	{
		...
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-", fitDistr, "fit-ppplot.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing ACF Plot" );
cat( "## ACF statistics and plot:", "\n" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-acf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-acf.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Plotting EDA Autocorrelation Plot" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-eda-acor.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( is( res, "try-error" ) )
{
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-eda-acor.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing Long Range Dependence indicators Plot" );
cat( "## Long Range Dependence indicators statistics and plots:", "\n" );

##@{ Aggregated trend plot
cat( "## LRD Aggregated Trends plot:", "\n" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-aggtrend.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-aggtrend.eps", sep = "" ) );
...
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-aggllecdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-aggllecdf.eps", sep = "" ) );
...
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-agglleccdf.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-agglleccdf.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-av.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-av.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-rs.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-rs.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-pgram.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-pgram.eps", sep = "" ) );
...
if ( !is( res, "try-error" ) )
{
	...
	postscript(
		file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-cumpgram.eps", sep = "" ),
		horizontal = FALSE,
		onefile = FALSE
	);
	res <- try(
	...
	if ( is( res, "try-error" ) )
	{
		unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-lrd-cumpgram.eps", sep = "" ) );
...
mg_debug.message( dbg, "[MG::APP::OVERALL::TERAGRID::RT>> Drawing Hill Plot" );
cat( "## Hill estimator:", "\n" );
postscript(
	file = paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-hill.eps", sep = "" ),
	horizontal = FALSE,
	onefile = FALSE
);
res <- try(
...
if ( !is( res, "try-error" ) )
{
	...
	unlink( paste( MG_APP_CONF_TERAGRID_IMGPATH, "/teragrid-overall-rt-hill.eps", sep = "" ) );
